...
public class ApiTest {
    ...
    private static final String appKey = "LTAIDyA5SjJwVhfL"; // 可替换为您的沙箱环境应用的appKey
    private static final String appSecret = "gKwJkVRs9W5MGbimvLz1pjJlWNPcyl"; // 可替换为您的沙箱环境应用的appSecret
//    private static final String sessionKey = "test"; // 必须替换为沙箱账号授权得到的真实有效sessionKey
    ...
    private static String getSellerItem() throws IOException {
        ...
        params.put("v", "2.0");
        // 业务参数
        params.put("extend", "793114465");
        params.put("rec_num", "13652390539");
        params.put("sms_free_sign_name", "123456789");
        params.put("sms_param", "[{\"key\":\"sms_param\",\"value\":\"{\\\"phone\\\":\\\"13652390539\\\",\\\"verify\\\":\\\"1234\\\"}\",\"description\":\"\"}]");
        params.put("sms_template_code", "SMS_ACG");
