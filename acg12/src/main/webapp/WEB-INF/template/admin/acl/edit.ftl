...
<div class="form-group">
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <div class="col-sm-9">
                <select name="parentId" id="parentId" data-placeholder="上级资源..." class="chosen-select"
                        style="width:350px;">
                    <option hassubinfo="true" value="">请选择资源</option>
                 	[#list acls as a]
                        ...
                        [#list a.children as child]
             			<option hassubinfo="true" value="${child.id}" [#if acl.id == child.id]selected[/#if]>
                            -----${child.name}</option>
                        [/#list]
                    [/#list]
                </select>
        ...
        <div class="col-sm-6">
            ...
            <div class="col-sm-9">
                <div class="input-group m-b">
                    ...
                    <span class="input-group-btn"> <button tabindex="-1" class="btn btn-white" type="button"
                                                           id="input-group-addon">[#if acl.icon??]<i
                            class="${acl.icon}"></i>[#else]<i>-</i>[/#if]</button><button type="button"
