        ...
        <div class="col-sm-9">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form id="saveAclForm" class="form-horizontal" action="saveOrUpdate.html" method="post">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="type" id="type" data-placeholder="选择类型..." class="chosen-select"
                                                style="width:350px;">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="parentId" id="parentId" data-placeholder="上级资源..."
                                            ...
                                            <option hassubinfo="true" value="">请选择资源</option>
	                                     	[#list acls as acl]
                                                ...
                                                [#list acl.children as child]
	                                 			<option hassubinfo="true" value="${child.id}">&nbsp;&nbsp;&nbsp;&nbsp;├
                                                    &nbsp;${child.name}</option>
                                                [/#list]
                                            [/#list]
                                        </select>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group m-b">
                                            ...
                                            <span class="input-group-btn"> <button tabindex="-1" class="btn btn-white"
                                                                                   type="button" id="input-group-addon"><i>-</i></button><button
                                                    type="button" class="btn btn-primary" data-toggle="modal"
                                                    data-target="#icon_choose">选择</button> </span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
