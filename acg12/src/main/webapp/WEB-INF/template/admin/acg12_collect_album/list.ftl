...
<head>
    ...
    <title>${setting.siteName} - CollectAlbum管理</title>
...
<body class="gray-bg">
    <div class="wrapper wrapper-content  animated fadeInRight">
        ...
        <div class="row">
         ...
         <div id="filter-div-userId"  class="col-sm-3 m-b-xs">
			<div class="input-group" >
			<input type="text" placeholder="请输入" name="filter_userIds" id="filter_userIds" class="input-sm form-control  ">
			<span class="input-group-addon">--</span>
			<input type="text" placeholder="请输入" name="filter_userIde" id="filter_userIde"  class="input-sm form-control  "> 
	         </div>
	      </div>
	        ...
	        <div  id="filter-div-pinId"  class="col-sm-3 m-b-xs">
				<input type="text" placeholder="请输入图片id" name="filter_pinId" id="filter_pinId"  class="input-sm form-control">
             </div>
	        ...
	        <div  id="filter-div-image"  class="col-sm-3 m-b-xs">
				<input type="text" placeholder="请输入图片url" name="filter_image" id="filter_image"  class="input-sm form-control">
             </div>
	        ...
	        <div  id="filter-div-linkUrl"  class="col-sm-3 m-b-xs">
				<input type="text" placeholder="请输入外链" name="filter_linkUrl" id="filter_linkUrl"  class="input-sm form-control">
             </div>
	        ...
	        <div  id="filter-div-content"  class="col-sm-3 m-b-xs">
				<input type="text" placeholder="请输入内容" name="filter_content" id="filter_content"  class="input-sm form-control">
             </div>
         ...
         <div id="filter-div-love"  class="col-sm-3 m-b-xs">
			<div class="input-group" >
			<input type="text" placeholder="请输入点赞" name="filter_loves" id="filter_loves" class="input-sm form-control  ">
			<span class="input-group-addon">--</span>
			<input type="text" placeholder="请输入点赞" name="filter_lovee" id="filter_lovee"  class="input-sm form-control  "> 
	         </div>
	      </div>
         ...
         <div id="filter-div-favorites"  class="col-sm-3 m-b-xs">
			<div class="input-group" >
			<input type="text" placeholder="请输入采集" name="filter_favoritess" id="filter_favoritess" class="input-sm form-control  ">
			<span class="input-group-addon">--</span>
			<input type="text" placeholder="请输入采集" name="filter_favoritese" id="filter_favoritese"  class="input-sm form-control  "> 
	         </div>
	      </div>
	    ...
	    <div id="filter-div-updatetime"  class="col-sm-3 m-b-xs">
			<div class="input-daterange input-group" id="datepicker">
			<input type="text" placeholder="请输入更新时间日期" name="filter_updatetimes" id="filter_updatetimes" class="input-sm form-control  ">
			<span class="input-group-addon">——</span>
			<input type="text" placeholder="请输入更新时间日期" name="filter_updatetimee" id="filter_updatetimee"  class="input-sm form-control  "> 
	         </div>
	      </div>
                           ...
                           <table id="Acg12CollectAlbum_list"  ></table>
                        </div>
                    </div>
                    </form>
                </div>
    ...
    <script>
   $('#Acg12CollectAlbum_list').bootstrapTable({
                method: 'get',
       ...
       {
         title: "", field: "userId",align: "center",valign: "middle",sortable:true
},
       {
         title: "图片id", field: "pinId",align: "center",valign: "middle",sortable:true
},
       {
         title: "图片url", field: "image",align: "center",valign: "middle",sortable:true
},
       {
         title: "外链", field: "linkUrl",align: "center",valign: "middle",sortable:true
},
       {
         title: "内容", field: "content",align: "center",valign: "middle",sortable:true
},
       {
         title: "点赞", field: "love",align: "center",valign: "middle",sortable:true
},
       {
         title: "采集", field: "favorites",align: "center",valign: "middle",sortable:true
},
       {
...
,formatter: function (value, row, index) {
  ...
  function queryParams(params) {  //配置参数  
    var temp = { 
      ...
      pageList: params.pageList,   //页面大小 
       ...
       filter_pinIdlike:$("#filter_pinId").val(),

       filter_imagelike:$("#filter_image").val(),

       filter_linkUrllike:$("#filter_linkUrl").val(),

       filter_contentlike:$("#filter_content").val(),

           filter_loves:$("#filter_loves").val(),
           filter_lovee:$("#filter_lovee").val(),


           filter_favoritess:$("#filter_favoritess").val(),
           filter_favoritese:$("#filter_favoritese").val(),
  ...
  function initColumns() { 
   ...
   [#list systemColumnList as systemColumn] 
	   $('#Acg12CollectAlbum_list').bootstrapTable('${systemColumn.columnType}','${systemColumn.columnName}');						     
   [/#list] 
     //  初始化搜索字段
...
//页面跳转
function refreshNum(){
        $('#Acg12CollectAlbum_list').bootstrapTable('selectPage', $('#searchPageNum').val());
};

//搜索按钮
 $(".btn-primary-search").click(function(){
        $('#Acg12CollectAlbum_list').bootstrapTable('selectPage', 1);
        $('#Acg12CollectAlbum_list').bootstrapTable(  
              "refresh",  
              {  
                  url:"listNew.json"
   ...
   function dels(val){
    bootbox.confirm(message("admin.dialog.deleteConfirm"), function(result) {
    var rows=  $.map(  $('#Acg12CollectAlbum_list').bootstrapTable('getSelections'), function(row) {
                return row.id
            });
     var ids="";
