...
<head>
    ...
    <title>${setting.siteName} - 新增CollectAlbum</title>
                          ...
                          <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" name="pinId" class="form-control" maxlength="200" />
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                          ...
                          <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" name="love" class="form-control" maxlength="200" />
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">采集</label>
	                                <div class="col-sm-9">
	                                    <input type="text" name="favorites" class="form-control" maxlength="200" />
	                                </div>
                       			</div>
							</div>
                        </div>
