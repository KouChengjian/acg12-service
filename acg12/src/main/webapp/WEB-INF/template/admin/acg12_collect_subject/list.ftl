...
<head>
    ...
    <title>${setting.siteName} - collectSubject管理</title>
...
<body class="gray-bg">
    <div class="wrapper wrapper-content  animated fadeInRight">
        ...
        <div class="row">
         ...
         <div id="filter-div-relevanceId"  class="col-sm-3 m-b-xs">
			<div class="input-group" >
			<input type="text" placeholder="请输入关联id" name="filter_relevanceIds" id="filter_relevanceIds" class="input-sm form-control  ">
			<span class="input-group-addon">--</span>
			<input type="text" placeholder="请输入关联id" name="filter_relevanceIde" id="filter_relevanceIde"  class="input-sm form-control  "> 
	         </div>
	      </div>
	        ...
	        <div  id="filter-div-name"  class="col-sm-3 m-b-xs">
				<input type="text" placeholder="请输入名称" name="filter_name" id="filter_name"  class="input-sm form-control">
             </div>
	        ...
	        <div  id="filter-div-nameCn"  class="col-sm-3 m-b-xs">
				<input type="text" placeholder="请输入中文名称" name="filter_nameCn" id="filter_nameCn"  class="input-sm form-control">
             </div>
         ...
         <div id="filter-div-type"  class="col-sm-3 m-b-xs">
			<div class="input-group" >
			<input type="text" placeholder="请输入0:subject 1:crt 2:preson" name="filter_types" id="filter_types" class="input-sm form-control  ">
			<span class="input-group-addon">--</span>
			<input type="text" placeholder="请输入0:subject 1:crt 2:preson" name="filter_typee" id="filter_typee"  class="input-sm form-control  "> 
	         </div>
	      </div>
	        ...
	        <div  id="filter-div-typeName"  class="col-sm-3 m-b-xs">
				<input type="text" placeholder="请输入类型名称" name="filter_typeName" id="filter_typeName"  class="input-sm form-control">
             </div>
	    ...
	    <div id="filter-div-updateTime"  class="col-sm-3 m-b-xs">
			...
			<input type="text" placeholder="请输入更新时间日期" name="filter_updateTimee" id="filter_updateTimee"  class="input-sm form-control  "> 
                           ...
                           <table id="Acg12CollectSubject_list"  ></table>
                        </div>
                    </div>
                    </form>
                </div>
    ...
    <script>
   $('#Acg12CollectSubject_list').bootstrapTable({
                method: 'get',
       ...
       {
         title: "关联id", field: "relevanceId",align: "center",valign: "middle",sortable:true
},
       {
       ...
       {
         title: "0:subject 1:crt 2:preson", field: "type",align: "center",valign: "middle",sortable:true
},
       {
...
,formatter: function (value, row, index) {
  ...
  function queryParams(params) {  //配置参数  
    var temp = { 
      ...
      pageList: params.pageList,   //页面大小 
           ...
           filter_relevanceIds:$("#filter_relevanceIds").val(),
           filter_relevanceIde:$("#filter_relevanceIde").val(),
  ...
  function initColumns() { 
   ...
   [#list systemColumnList as systemColumn] 
	   $('#Acg12CollectSubject_list').bootstrapTable('${systemColumn.columnType}','${systemColumn.columnName}');						     
   [/#list] 
     //  初始化搜索字段
...
//页面跳转
function refreshNum(){
        $('#Acg12CollectSubject_list').bootstrapTable('selectPage', $('#searchPageNum').val());
};

//搜索按钮
 $(".btn-primary-search").click(function(){
        $('#Acg12CollectSubject_list').bootstrapTable('selectPage', 1);
        $('#Acg12CollectSubject_list').bootstrapTable(  
              "refresh",  
              {  
                  url:"listNew.json"
   ...
   function dels(val){
    bootbox.confirm(message("admin.dialog.deleteConfirm"), function(result) {
    var rows=  $.map(  $('#Acg12CollectSubject_list').bootstrapTable('getSelections'), function(row) {
                return row.id
            });
     var ids="";
