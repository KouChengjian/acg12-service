                ...
                <form id="listForm" action="list.html" method="get">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            ...
                            <div id="filter-div-subjectId" class="col-sm-3 m-b-xs">
                                <div class="input-group">
                                    <input type="text" placeholder="请输入" name="filter_subjectIds" id="filter_subjectIds"
                                           class="input-sm form-control  ">
                                    <span class="input-group-addon">--</span>
                                    <input type="text" placeholder="请输入" name="filter_subjectIde" id="filter_subjectIde"
                                           class="input-sm form-control  ">
                                </div>
                            </div>
                            ...
                            <div id="filter-div-sId" class="col-sm-3 m-b-xs">
                                <div class="input-group">
                                    <input type="text" placeholder="请输入外部获取的id" name="filter_sIds" id="filter_sIds"
                                           class="input-sm form-control  ">
                                    <span class="input-group-addon">--</span>
                                    <input type="text" placeholder="请输入外部获取的id" name="filter_sIde" id="filter_sIde"
                                           class="input-sm form-control  ">
                                </div>
                            </div>


                            <div id="filter-div-otherTitle" class="col-sm-3 m-b-xs">
                                <input type="text" placeholder="请输入标题" name="filter_otherTitle" id="filter_otherTitle"
                                       class="input-sm form-control">
                            </div>


                            <div id="filter-div-otherValue" class="col-sm-3 m-b-xs">
                                <input type="text" placeholder="请输入值" name="filter_otherValue" id="filter_otherValue"
                                       class="input-sm form-control">
                            </div>
