            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src=${principal.avatar}/></span>
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            ...
                            <li class="divider"></li>
                            <li><a href="${base}/admin/common/logout.html">安全退出</a>
                            </li>
                        </ul>
                    </div>
                ...
                <li>
                    <a  href="javascript:;" data-index="0" data-href="${base}/admin/common/index.html">
	                        	...
	                        	[#list acl.children as a]
		                            ...
		                            <li>
                                        <a class="J_menuItem" href="javascript:;"
                                           data-href="${base}${a.url}">[#if a.icon??]<i
                                                class="${a.icon}"></i>[/#if]${a.name}</a>
                                    </li>
                                    [/@shiro.hasPermission]
                                [/#list]
                            </ul>
                        [#else]
                    		<a class="J_menuItem" href="javascript:;" data-href="${base}${acl.url}"><i
                                    class="${acl.icon}"></i> <span class="nav-label">${acl.name}</span></a>
                        [/#if]
                    </li>
                    [/@shiro.hasPermission]
                [/#list]
        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="hidden-xs">
                        <a href="index_v1.html" class="J_menuItem" ><i class="fa fa-cart-arrow-down"></i>
                            购买</a>
                    </li>
        ...
        <div class="row content-tabs">
            ...
            <nav class="page-tabs J_menuTabs">
                <div class="page-tabs-content">
                    <a href="javascript:;" class="active J_menuTab" data-id="${base}/admin/common/index.html">首页</a>
                </div>
            </nav>
            ...
            <a href="${base}/admin/common/logout.html" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
        </div>
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${base}/admin/common/index.html" frameborder="0"
                    data-id="${base}/admin/common/index.html" seamless></iframe>
        </div>
        <div class="footer">
...
<script src="${base}/resources/js/contabs.js" type="text/javascript"></script>
