...
<head>
    ...
    <title>${setting.siteName} - personDetail管理</title>
                ...
                <form id="listForm" action="list.html" method="get">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="dataTables_wrapper form-inline">
                            <table id="Acg12PersonDetail_list"></table>
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    $('#Acg12PersonDetail_list').bootstrapTable({
        method: 'get',
        ...
        columns: [
            {checkbox: true},
            {
                title: "id", field: "id", align: "center", valign: "middle", sortable: true, width: "100"
            },
            {
                title: "personId", field: "personId", align: "center", valign: "middle", sortable: true, width: "100"
            },
            {
                title: "标题", field: "otherTitle", align: "center", valign: "middle", sortable: true, width: "150"
            },
            {
                title: "内容", field: "otherValue", align: "center", valign: "middle", sortable: true
            },
            {
    ...
    function initColumns() {
        ...
        [#list systemColumnList as systemColumn]
	       $('#Acg12PersonDetail_list').bootstrapTable('${systemColumn.columnType}', '${systemColumn.columnName}');
        [/#list]
        //  初始化搜索字段
    ...
    //页面跳转
    function refreshNum() {
        $('#Acg12PersonDetail_list').bootstrapTable('selectPage', $('#searchPageNum').val());
    };

    //搜索按钮
    $(".btn-primary-search").click(function () {
        $('#Acg12PersonDetail_list').bootstrapTable('selectPage', 1);
        $('#Acg12PersonDetail_list').bootstrapTable(
                "refresh",
                {
                    url: "listNew.json"
    ...
    function dels(val) {
        bootbox.confirm(message("admin.dialog.deleteConfirm"), function (result) {
            var rows = $.map($('#Acg12PersonDetail_list').bootstrapTable('getSelections'), function (row) {
                return row.id
            });
            var ids = "";
