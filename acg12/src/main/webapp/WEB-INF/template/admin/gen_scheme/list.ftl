                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example dataTable">
                                ...
                                <tbody>
                                 ...
                                 <tr>
                                     ...
                                     <td>${scheme.author!''}</td>
                                     <td>
                                         <a class="btn btn-info btn-xs btn-gen-loippi" data-id="${scheme.id}"><i
                                                 class="fa fa-code"></i> 生成代码</a>
                                         <a class="btn btn-danger btn-xs btn-delete-loippi" data-id="${scheme.id}"><i
                                                 class="fa fa-trash"></i> 删除</a>
                                     </td>
                                 </tr>
                                 [/#list]
