...
<head>
    ...
    <title>${setting.siteName} - CollectCaricature管理</title>
...
<body class="gray-bg">
    <div class="wrapper wrapper-content  animated fadeInRight">
        ...
        <div class="row">
         ...
         <div id="filter-div-comicId"  class="col-sm-3 m-b-xs">
			<div class="input-group" >
			<input type="text" placeholder="请输入comicId" name="filter_comicIds" id="filter_comicIds" class="input-sm form-control  ">
			<span class="input-group-addon">--</span>
			<input type="text" placeholder="请输入comicId" name="filter_comicIde" id="filter_comicIde"  class="input-sm form-control  "> 
	         </div>
	      </div>
         ...
         <div id="filter-div-type"  class="col-sm-3 m-b-xs">
			<div class="input-group" >
			<input type="text" placeholder="请输入类型 1:酷克" name="filter_types" id="filter_types" class="input-sm form-control  ">
			<span class="input-group-addon">--</span>
			<input type="text" placeholder="请输入类型 1:酷克" name="filter_typee" id="filter_typee"  class="input-sm form-control  "> 
	         </div>
	      </div>
	        ...
	        <div  id="filter-div-cover"  class="col-sm-3 m-b-xs">
				<input type="text" placeholder="请输入封面" name="filter_cover" id="filter_cover"  class="input-sm form-control">
             </div>
	    ...
	    <div id="filter-div-updatetime"  class="col-sm-3 m-b-xs">
			...
			<input type="text" placeholder="请输入更新时间日期" name="filter_updatetimee" id="filter_updatetimee"  class="input-sm form-control  "> 
                           ...
                           <table id="Acg12CollectCaricature_list"  ></table>
                        </div>
                    </div>
                    </form>
                </div>
    ...
    <script>
   $('#Acg12CollectCaricature_list').bootstrapTable({
                method: 'get',
       ...
       {
         title: "comicId", field: "comicId",align: "center",valign: "middle",sortable:true
},
       {
         title: "类型 1:酷克", field: "type",align: "center",valign: "middle",sortable:true
},
       {
...
,formatter: function (value, row, index) {
  ...
  function queryParams(params) {  //配置参数  
    var temp = { 
      ...
      pageList: params.pageList,   //页面大小 
            ...
            filter_comicIds:$("#filter_comicIds").val(),
            filter_comicIde:$("#filter_comicIde").val(),
  ...
  function initColumns() { 
   ...
   [#list systemColumnList as systemColumn] 
	   $('#Acg12CollectCaricature_list').bootstrapTable('${systemColumn.columnType}','${systemColumn.columnName}');						     
   [/#list] 
     //  初始化搜索字段
...
//页面跳转
function refreshNum(){
        $('#Acg12CollectCaricature_list').bootstrapTable('selectPage', $('#searchPageNum').val());
};

//搜索按钮
 $(".btn-primary-search").click(function(){
        $('#Acg12CollectCaricature_list').bootstrapTable('selectPage', 1);
        $('#Acg12CollectCaricature_list').bootstrapTable(  
              "refresh",  
              {  
                  url:"listNew.json"
   ...
   function dels(val){
    bootbox.confirm(message("admin.dialog.deleteConfirm"), function(result) {
    var rows=  $.map(  $('#Acg12CollectCaricature_list').bootstrapTable('getSelections'), function(row) {
                return row.id
            });
     var ids="";
