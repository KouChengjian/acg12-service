...
<head>
    ...
    <title>${setting.siteName} - subjectCrt管理</title>
                ...
                <form id="listForm" action="list.html" method="get">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="dataTables_wrapper form-inline">
                            <table id="Acg12SubjectCrt_list"></table>
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    $('#Acg12SubjectCrt_list').bootstrapTable({
        method: 'get',
        ...
        columns: [
            ...
            {
                title: "subjectId", field: "subjectId", align: "center", valign: "middle", sortable: true
            },
            {
                title: "sId", field: "sId", align: "center", valign: "middle", sortable: true
            },
            {
                title: "cId", field: "cId", align: "center", valign: "middle", sortable: true
            },
            {
            ...
            {
                title: "中文名", field: "nameN", align: "center", valign: "middle", sortable: true
            },
            {
                title: "扮演者身份", field: "roleName", align: "center", valign: "middle", sortable: true
            },
            {
                title: "图片", field: "image", align: "center", valign: "middle", sortable: true, visible: false
            },
            {
                title: "扮演者名称", field: "pName", align: "center", valign: "middle", sortable: true
            },
            {
                title: "扮演者中文名", field: "pNameCn", align: "center", valign: "middle", sortable: true
            },
            {
    ...
    function queryParams(params) {  //配置参数
        var temp = {
            ...
            filter_subjectIds: $("#filter_subjectIds").val(),
            filter_subjectIde: $("#filter_subjectIde").val(),
            ...
            filter_nameNlike: $("#filter_nameN").val(),

            filter_roleNamelike: $("#filter_roleName").val(),

            filter_imagelike: $("#filter_image").val(),

            filter_pNamelike: $("#filter_pName").val(),

            filter_pNameCnlike: $("#filter_pNameCn").val(),

            filter_pImagelike: $("#filter_pImage").val(),
    ...
    function initColumns() {
        ...
        [#list systemColumnList as systemColumn]
	        $('#Acg12SubjectCrt_list').bootstrapTable('${systemColumn.columnType}', '${systemColumn.columnName}');
        [/#list]
        //  初始化搜索字段
    ...
    //页面跳转
    function refreshNum() {
        $('#Acg12SubjectCrt_list').bootstrapTable('selectPage', $('#searchPageNum').val());
    };

    //搜索按钮
    $(".btn-primary-search").click(function () {
        $('#Acg12SubjectCrt_list').bootstrapTable('selectPage', 1);
        $('#Acg12SubjectCrt_list').bootstrapTable(
                "refresh",
                {
                    url: "listNew.json"
    ...
    function dels(val) {
        bootbox.confirm(message("admin.dialog.deleteConfirm"), function (result) {
            var rows = $.map($('#Acg12SubjectCrt_list').bootstrapTable('getSelections'), function (row) {
                return row.id
            });
            var ids = "";
