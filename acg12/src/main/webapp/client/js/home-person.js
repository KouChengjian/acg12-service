        ...
        if (xhr.readyState == 4) {  //状态等于4的时候返回值
            if (xhr.status == 200 || xhr.status == 304) {
                ...
                if (data.code == 20000) {
                    ...
                    var m_style = document.getElementsByClassName("m-style");
                    page.removeChild(m_style[0])
...
function paddingHtml(item) {
    ...
    h += "<a href=\"/person/32510\" class=\"avatar\">";
    h += "<img src=\"" + item.image + "\" class=\"avatar\">";
    h += "</a>";
    h += "<div style=\"padding-left: 90px;\">";
    h += "<h3><a href=\"/person/32510\" class=\"l on\">" + getTitle(item) + "</a></h3>";
