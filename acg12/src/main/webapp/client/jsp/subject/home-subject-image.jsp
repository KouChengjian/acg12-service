...
<head>
    ...
    <link rel="stylesheet" href="/acg12/view/css/common/waterfall/waterfall.css" >
    <link rel="stylesheet" href="/acg12/view/css/home-subject-info.css" >
    <link rel="stylesheet" href="/acg12/view/css/subject/home-subject-images.css" >
    ...
    <script type="text/javascript" src="/acg12/view/js/common/waterfall/waterfall.js"></script>
...
<div>
    ...
    <div class="container" style="display: <%=result.getsId()== null ? "none" :"" %>;">
        <div class="container-center">
            ...
            <%--<jsp:include page="home-subject-header.jsp" flush="true">--%>
            ...
            <div class="container-tabs">
                <div class="tabs-content">
                    <a href="/nonononomad/" class="tab ">资源</a>
                    <a href="/nonononomad/" class="tab active">插画</a>
            ...
            <div class="container-info">
                <div id="wrap">
                    <div class="box">
                        <div class="info">
                            <a class="image">
                                <img src="http://lain.bgm.tv/pic/cover/l/f2/6d/1836_5fH2v.jpg" alt="スカイ・クロラ">
                            </a>
                            <p class="description">
                                Anime 1920x1080 anime anime girls school uniform
                            </p>
                            <p class="stats">
                                <span title="转采" class="repin"><i></i>10</span>
                                <span title="喜欢" class="like"><i></i>4</span>
                            </p>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" charset="UTF-8">
    ...
    var left = <%=n1%>;
    var catLine =<%=n2%>;
    var key = "<%=result.getNameCn()==null ? result.getName() : result.getNameCn()%>";
    document.title = "<%=title%>";
</script>
<script type="text/javascript" src="/acg12/view/js/subject/home-subject-images.js"></script>
</body>
</html>
