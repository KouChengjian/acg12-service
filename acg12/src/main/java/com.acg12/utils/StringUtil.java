...
import com.acg12.entity.view.MenuItem;
import com.acg12.utils.stack.IndexStack;
import com.acg12.utils.stack.MyStack;
...
//        System.out.println(sb.toString());
    ...
    public static List<ArrayList<SubjectStaffDao>> getSubjectStaffDaoList(List<SubjectStaffEntity> subjectStaffEntityList){
        List<ArrayList<SubjectStaffDao>> subjectStaffDaos = new ArrayList<>();
        ArrayList<SubjectStaffDao> groups = new ArrayList<>();
        for (int i = 0 , num = subjectStaffEntityList.size() ; i < num ; i++){
            SubjectStaffEntity curEntity = subjectStaffEntityList.get(i);
            SubjectStaffDao subjectStaffDao = new SubjectStaffDao();
