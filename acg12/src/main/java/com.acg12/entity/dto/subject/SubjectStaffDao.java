...
public class SubjectStaffDao {
    ...
    private String name;
    private String job;
    private List<SubjectStaffDao> subjectStaffDaos = new ArrayList<>();
    ...
    public List<SubjectStaffDao> getSubjectStaffDaos() {
        return subjectStaffDaos;
    }

    public void setSubjectStaffDaos(List<SubjectStaffDao> subjectStaffDaos) {
