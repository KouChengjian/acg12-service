...
*/
    ...
    /**
     * Date转 时间格式yyyyMMddHHmmss
     *
     * @param date
     * @return 时间格式yyyyMMddHHmmss
     */
    public static String date2StringTime2(Date date) {
    ...
    /**
     * Date转 时间格式yyyy年MM月dd日 HH:mm
     *
     * @param date
     * @return 时间格式yyyy年MM月dd日 HH:mm
     */
    public static String date2String42(Date date) {
    ...
    /**
     * Date转 时间格式X月X日 XX：xx
     *
     * @param date
     * @return 时间格式X月X日 XX：xx
     */
    public static String date2String6(Date date) {
        ...
        String str = month + "月" + day + "日" + " " + format1.format(date);
        return str;
    ...
    public static Date DateAddHour(Date date, int i) {
        ...
        Calendar calendar = new GregorianCalendar();
        calendar.setTime(date);
        calendar.add(calendar.HOUR_OF_DAY, i);//把日期往后增加一天.整数往后推,负数往前移动
        return date = calendar.getTime();
    }
     ...
     * @return date
     */
    public static String s2hms(Long i) {
        long ms = i;//毫秒数
...
//		date2String(null);
        System.err.println(StringUtil.secToTime(51));
    }
