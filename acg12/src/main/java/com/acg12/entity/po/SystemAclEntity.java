...
public class SystemAclEntity implements GenericEntity {
    ...
    /** 上级菜单 */
    private SystemAclEntity parent;

    /** 下级菜单 */
    private List<SystemAclEntity> children = new ArrayList<SystemAclEntity>();
