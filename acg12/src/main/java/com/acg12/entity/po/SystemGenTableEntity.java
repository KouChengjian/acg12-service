...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "T_SYSTEM_GEN_TABLE")
public class SystemGenTableEntity implements GenericEntity {
	...
	/** 字段列表 */
	private List<SystemGenTableColumnEntity> columns = new ArrayList<SystemGenTableColumnEntity>();
	
	
	
	public String getClassPk(){
		if(CollectionUtils.isNotEmpty(getColumns())){
			for (SystemGenTableColumnEntity genTableColumn : getColumns()) {
