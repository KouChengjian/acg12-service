...
public class Acg12VideoDto {
	...
	private List<Acg12VideoDto> bangumiVideoList; // 番剧列表
	private List<Acg12VideoDto> quarterVideoList; // 季度视频
	...
	public List<Acg12VideoDto> getBangumiVideoList() {
		return bangumiVideoList;
	}

	public void setBangumiVideoList(List<Acg12VideoDto> bangumiVideoList) {
		this.bangumiVideoList = bangumiVideoList;
	}

	public List<Acg12VideoDto> getQuarterVideoList() {
		return quarterVideoList;
	}

	public void setQuarterVideoList(List<Acg12VideoDto> quarterVideoList) {
